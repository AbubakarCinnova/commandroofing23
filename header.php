...
<body>
    <header class="header-wrapper">
        ...
        <div class="mid-header  ">
            <div class="container">
                <div class=" col-sm-12 text-center hidden-xs main-logo"> <a href="<?php echo $base_url; ?>/"><img
                            src="<?php echo $base_url; ?>/images/logo.png" class="img-responsive logo-lg"></a> </div>
            </div>
        </div>
        ...
        <nav class="navbar">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="#" class="navbar-brand visible-xs"> <img src="<?php echo $base_url; ?>/images/logo.png"
